...
const toastVariants = {
  ...
  destructive: 'destructive border-destructive/50 bg-bg-elevated text-destructive',
  success: 'border-primary/40 bg-bg-elevated text-fg border-l-2 border-l-primary',
};
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn('absolute right-1 top-1 rounded-md p-1 text-fg-muted hover:text-fg', className)}
    toast-close=""
    {...props}
  >
    <X className="h-4 w-4" />
